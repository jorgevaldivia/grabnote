  ...
  module Inputs
    module Base
      module Stringish
        ...
        def default_class
          options[:input_html].try(:class) || "form-control"
        end
      end
    end
  end
...
# FormtasticBootstrap monkey patches
module FormtasticBootstrap
  module Actions
    class InputAction < Formtastic::Actions::InputAction

      # Adds "btn-primary" class to submit buttons automatically
      def default_button_html
        options = super
        options[:class] = ((options[:class] || "").split << "btn-primary").join(" ") if method == :submit
        options
      end
